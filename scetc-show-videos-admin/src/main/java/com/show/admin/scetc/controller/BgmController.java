...
public class BgmController extends BasicController {
    ...
    public LybJsonResult selectBgmList(String keyword, String title,
    ...
    public LybJsonResult updateBgm(Long id, String status, String author, String name) {
    ...
    public @ResponseBody
    LybJsonResult uploadMulPic(HttpServletRequest request) throws Exception {
